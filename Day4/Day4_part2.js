            ...
            .then((content) =>{
                ...
                assignments.forEach(couple => {
                    ...
                    if (// total overlap
                        ...
                        // partial overlap
                        parseInt(elf2[0]) >= parseInt(elf1[0]) && parseInt(elf2[0]) <= parseInt(elf1[1]) && parseInt(elf2[1]) > parseInt(elf1[1]) ||
                        parseInt(elf1[0]) >= parseInt(elf2[0]) && parseInt(elf1[0]) <= parseInt(elf2[1]) && parseInt(elf1[1]) > parseInt(elf2[1])){
                        count++;
                    }
